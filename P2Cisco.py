...
# -*- coding: utf-8 -*-
# p2Cisco.py
# Using Python control cisco
# Created by Randy Chen
# Aug 1st 2016
# Last update Aug 1st 2016
...
def cisco_send_command:
    pass

def craw_cisco(x,command):
    # Create Export Files
...
def craw0_cisco(x,y,z,t,command):
    # Create Export Files
    routerconfig = open('./config/password.txt')
    routerconfig_line = routerconfig.readlines()
    router_name = routerconfig_line[0].replace('\n','')
